...
func (r ClearRepositoriesMeteringArchive) Perform(ctx context.Context) (*http.Response, error) {
...
func (r ClearRepositoriesMeteringArchive) Do(ctx context.Context) (*Response, error) {

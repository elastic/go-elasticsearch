...
func (r DeleteCalendar) Perform(ctx context.Context) (*http.Response, error) {
...
func (r DeleteCalendar) Do(ctx context.Context) (*Response, error) {
...
// API Name: calendarid
func (r *DeleteCalendar) CalendarId(calendarid string) *DeleteCalendar {

...
func (r CreateCrossClusterApiKey) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the CreateCrossClusterApiKey query execution: %w", err)
	}
...
func (r CreateCrossClusterApiKey) IsSuccess(ctx context.Context) (bool, error) {

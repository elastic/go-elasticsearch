...
// Nonce Associate a client session with an ID token and mitigate replay attacks. This
// value needs to be the same as the one that was provided to the
...
// Realm The name of the OpenID Connect realm. This property is useful in cases where
...
// URL must be provided as-is (URL encoded), taken from the body of the response
// or as the value of a location header in the response from the OpenID Connect
// Provider.
...
// State Maintain state between the authentication request and the response. This
// value needs to be the same as the one that was provided to the
// `/_security/oidc/prepare` API or the one that was generated by Elasticsearch
// and included in the response to that call.
// API name: state

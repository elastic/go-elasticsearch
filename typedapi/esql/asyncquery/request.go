...
//
// https://github.com/elastic/elasticsearch-specification/blob/e196f9953fa743572ee46884835f1934bce9a16b/specification/esql/async_query/AsyncQueryRequest.ts#L28-L149
type Request struct {
...
func (s *Request) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "include_ccs_metadata", "include_execution_metadata":
			var tmp any
			dec.Decode(&tmp)
			switch v := tmp.(type) {
			case string:

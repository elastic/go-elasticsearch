...
//
// https://github.com/elastic/elasticsearch-specification/blob/d82ef79f6af3e5ddb412e64fc4477ca1833d4a27/specification/_global/reindex/ReindexResponse.ts#L27-L97
type Response struct {
	...
	// Slices Status of each slice if the reindex was sliced

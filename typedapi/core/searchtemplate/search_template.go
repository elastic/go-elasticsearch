...
// Run a search with a search template.
//
// [Elasticsearch] https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-search-template
//
...
// The ID of the search template to use. If no `source` is specified, this

...
// completes. This is different to the update API's `refresh` parameter, which
// causes only the shard that received the request to be refreshed. Unlike the
// update API, it does not support `wait_for`.
//
// # Running update by query asynchronously
//
// If the request contains `wait_for_completion=false`, Elasticsearch performs
// some preflight checks, launches the request, and returns a
...
// API name: _slice
func (r *UpdateByQuery) RouteSlice_(routeslice_ string) *UpdateByQuery {

...
// ForceSyntheticSource Indicates whether the request forces synthetic `_source`. Use this paramater
...
// fields can be retrieved with the `stored_field` option. Object fields can't

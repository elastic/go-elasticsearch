...
func (r GetWatch) Perform(ctx context.Context) (*http.Response, error) {
...
func (r GetWatch) Do(ctx context.Context) (*Response, error) {
...
// Id Watch ID
// API Name: id
func (r *GetWatch) Id(id string) *GetWatch {
	r.paramSet |= idMask
	r.id = id

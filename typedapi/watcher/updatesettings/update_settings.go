...
func (r UpdateSettings) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the UpdateSettings query execution: %w", err)
	}
...
func (r UpdateSettings) IsSuccess(ctx context.Context) (bool, error) {

...
// capabilities API may be more useful.
//
// https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-rollup-get-jobs
//
// Deprecated: Since 8.11.0.
...
func (r GetJobs) Perform(providedCtx context.Context) (*http.Response, error) {
	...
	if instrument, ok := r.instrument.(elastictransport.Instrumentation); ok {
		...
		if reader := instrument.RecordRequestBody(ctx, "rollup.get_jobs", r.raw); reader != nil {
			req.Body = reader
		}
	}

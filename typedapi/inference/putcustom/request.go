...
//
// https://github.com/elastic/elasticsearch-specification/blob/907d11a72a6bfd37b777d526880c56202889609e/specification/inference/put_custom/PutCustomRequest.ts#L30-L117
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putcustom request: %w", err)
	}

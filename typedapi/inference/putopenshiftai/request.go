...
// Request holds the request body struct for the package putopenshiftai
//
// https://github.com/elastic/elasticsearch-specification/blob/55f8d05b44cea956ae5ceddfcb02770ea2a24ff6/specification/inference/put_openshift_ai/PutOpenShiftAiRequest.ts#L31-L92
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putopenshiftai request: %w", err)
	}

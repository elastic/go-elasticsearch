...
// Request holds the request body struct for the package putnvidia
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/inference/put_nvidia/PutNvidiaRequest.ts#L31-L90
type Request struct {
	...
	// TaskSettings Settings to configure the inference task. Applies only to the
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putnvidia request: %w", err)
	}

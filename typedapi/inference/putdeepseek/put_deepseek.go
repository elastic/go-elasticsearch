...
// service.
//
// [Elasticsearch] https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-inference-put-deepseek
//
...
func (r *PutDeepseek) ServiceSettings(servicesettings types.DeepSeekServiceSettingsVariant) *PutDeepseek {
	...
	r.req.ServiceSettings = *servicesettings.DeepSeekServiceSettingsCaster()

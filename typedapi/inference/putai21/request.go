...
//
// https://github.com/elastic/elasticsearch-specification/blob/aa1459fbdcaf57c653729142b3b6e9982373bb1c/specification/inference/put_ai21/PutAi21Request.ts#L29-L73
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putai21 request: %w", err)
	}

...
// NewPutAi21Func returns a new instance of PutAi21 with the provided transport.
// Used in the index of the library this allows to retrieve every apis in once place.
func NewPutAi21Func(tp elastictransport.Interface) NewPutAi21 {
	return func(tasktype, ai21inferenceid string) *PutAi21 {
		n := New(tp)

		n._tasktype(tasktype)

		n._ai21inferenceid(ai21inferenceid)
...
// service.
//
// [Elasticsearch] https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-inference-put-ai21
//
...
func (r *PutAi21) HttpRequest(ctx context.Context) (*http.Request, error) {
	...
	if r.raw == nil && r.req != nil {
		...
		if err != nil {
			return nil, fmt.Errorf("could not serialise request for PutAi21: %w", err)
		}
	...
	switch {
	case r.paramSet == tasktypeMask|ai21inferenceidMask:
		path.WriteString("/")
		...
		if instrument, ok := r.instrument.(elastictransport.Instrumentation); ok {
			instrument.RecordPathPart(ctx, "ai21inferenceid", r.ai21inferenceid)
		}
...
func (r PutAi21) Perform(providedCtx context.Context) (*http.Response, error) {
	...
	if instrument, ok := r.instrument.(elastictransport.Instrumentation); ok {
		...
		if reader := instrument.RecordRequestBody(ctx, "inference.put_ai21", r.raw); reader != nil {
			req.Body = reader
		}
	}
	...
	if err != nil {
		localErr := fmt.Errorf("an error happened during the PutAi21 query execution: %w", err)
		if instrument, ok := r.instrument.(elastictransport.Instrumentation); ok {
...
// API Name: tasktype
func (r *PutAi21) _tasktype(tasktype string) *PutAi21 {
...
// Ai21InferenceId The unique identifier of the inference endpoint.
// API Name: ai21inferenceid
func (r *PutAi21) _ai21inferenceid(ai21inferenceid string) *PutAi21 {
	r.paramSet |= ai21inferenceidMask
	r.ai21inferenceid = ai21inferenceid
...
func (r *PutAi21) ServiceSettings(servicesettings types.Ai21ServiceSettingsVariant) *PutAi21 {
	...
	r.req.ServiceSettings = *servicesettings.Ai21ServiceSettingsCaster()

...
//
// https://github.com/elastic/elasticsearch-specification/blob/b1811e10a0722431d79d1c234dd412ff47d8656f/specification/inference/put_contextualai/PutContextualAiRequest.ts#L30-L83
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putcontextualai request: %w", err)
	}

...
//
// https://github.com/elastic/elasticsearch-specification/blob/e196f9953fa743572ee46884835f1934bce9a16b/specification/inference/put_elasticsearch/PutElasticsearchRequest.ts#L31-L103
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putelasticsearch request: %w", err)
	}

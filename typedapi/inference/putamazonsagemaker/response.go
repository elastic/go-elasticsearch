...
import (
	...
	"github.com/elastic/go-elasticsearch/v9/typedapi/types/enums/tasktypeamazonsagemaker"
)

// Response holds the response body struct for the package putamazonsagemaker
//
// https://github.com/elastic/elasticsearch-specification/blob/907d11a72a6bfd37b777d526880c56202889609e/specification/inference/put_amazonsagemaker/PutAmazonSageMakerResponse.ts#L22-L25
type Response struct {
	...
	TaskType tasktypeamazonsagemaker.TaskTypeAmazonSageMaker `json:"task_type"`
}

...
import (
	...
	"github.com/elastic/go-elasticsearch/v9/typedapi/types/enums/tasktypefireworksai"
)

// Response holds the response body struct for the package putfireworksai
//
// https://github.com/elastic/elasticsearch-specification/blob/836fca874204ca4173ae5c36fb6b5107d28d2fc0/specification/inference/put_fireworksai/PutFireworksAiResponse.ts#L22-L25
type Response struct {
	...
	TaskType tasktypefireworksai.TaskTypeFireworksAI `json:"task_type"`
}

...
// <https://jina.ai/embeddings/>.
//
// [Elasticsearch] https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-inference-put-jinaai
//
...
// The chunking configuration object. Applies only to the `embedding` and

...
func (r PromoteDataStream) Perform(ctx context.Context) (*http.Response, error) {
...
func (r PromoteDataStream) Do(ctx context.Context) (Response, error) {
...
// API Name: name
func (r *PromoteDataStream) Name(name string) *PromoteDataStream {
	r.paramSet |= nameMask
	r.name = name

...
//
// https://github.com/elastic/elasticsearch-specification/blob/d82ef79f6af3e5ddb412e64fc4477ca1833d4a27/specification/indices/put_data_stream_options/IndicesPutDataStreamOptionsRequest.ts#L25-L83
type Request struct {
...
func (r *Request) FromJSON(data string) (*Request, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("could not deserialise json into Putdatastreamoptions request: %w", err)
	}

...
// also cause the `remote/info` endpoint to now indicate a connected status.
//
// https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-indices-resolve-cluster
...
// allowed and the request returns an empty result. NOTE: This option is only
// supported when specifying an index expression. You will get an error if you
// specify index options to the `_resolve/cluster` API endpoint that takes no
// index expression.
...
// will get an error if you specify index options to the `_resolve/cluster` API
// endpoint that takes no index expression.
...
// ignored. NOTE: This option is only supported when specifying an index
...
// Timeout The maximum time to wait for remote clusters to respond. If a remote cluster

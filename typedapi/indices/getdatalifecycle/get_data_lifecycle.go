...
// streams
// API Name: name
func (r *GetDataLifecycle) Name(v string) *GetDataLifecycle {
	r.paramSet |= nameMask
	r.name = v
...
func (r *GetDataLifecycle) ExpandWildcards(v string) *GetDataLifecycle {
...
func (r *GetDataLifecycle) IncludeDefaults(b bool) *GetDataLifecycle {

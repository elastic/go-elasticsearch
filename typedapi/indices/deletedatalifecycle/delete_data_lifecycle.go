...
// NewDeleteDataLifecycleFunc returns a new instance of DeleteDataLifecycle with the provided transport.
// Used in the index of the library this allows to retrieve every apis in once place.
func NewDeleteDataLifecycleFunc(tp elastictransport.Interface) NewDeleteDataLifecycle {
	return func(name string) *DeleteDataLifecycle {
		n := New(tp)
...
func (r DeleteDataLifecycle) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the DeleteDataLifecycle query execution: %w", err)
	}
...
func (r DeleteDataLifecycle) Do(ctx context.Context) (*Response, error) {
...
// API Name: name
func (r *DeleteDataLifecycle) Name(v string) *DeleteDataLifecycle {
	r.paramSet |= nameMask
	r.name = v
...
func (r *DeleteDataLifecycle) ExpandWildcards(v string) *DeleteDataLifecycle {
...
func (r *DeleteDataLifecycle) MasterTimeout(v string) *DeleteDataLifecycle {
...
// API name: timeout
func (r *DeleteDataLifecycle) Timeout(v string) *DeleteDataLifecycle {

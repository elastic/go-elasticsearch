...
//
// https://github.com/elastic/elasticsearch-specification/blob/b1811e10a0722431d79d1c234dd412ff47d8656f/specification/indices/put_mapping/IndicesPutMappingRequest.ts#L42-L172
type Request struct {
		...
		case "properties":
			...
			for key, message := range refs {
				...
				case "exponential_histogram":
					oo := types.NewExponentialHistogramProperty()
					if err := localDec.Decode(&oo); err != nil {
						return fmt.Errorf("Properties | %w", err)
					}
					s.Properties[key] = oo

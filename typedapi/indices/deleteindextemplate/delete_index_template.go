...
func (r DeleteIndexTemplate) Perform(ctx context.Context) (*http.Response, error) {
...
func (r DeleteIndexTemplate) Do(ctx context.Context) (*Response, error) {
...
// API Name: name
func (r *DeleteIndexTemplate) Name(name string) *DeleteIndexTemplate {
	r.paramSet |= nameMask
	r.name = name

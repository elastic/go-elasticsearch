...
// the nodes info API.
//
// https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-cat-nodeattrs
...
func (r *Nodeattrs) H(catnodeattrscolumns ...catnodeattrscolumn.CatNodeattrsColumn) *Nodeattrs {
	tmp := []string{}
	for _, item := range catnodeattrscolumns {
...
// API name: bytes
func (r *Nodeattrs) Bytes(bytes bytes.Bytes) *Nodeattrs {
...
// API name: time
func (r *Nodeattrs) Time(time timeunit.TimeUnit) *Nodeattrs {

...
// the nodes info API.
//
// https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-cat-nodes
...
// API name: full_id
func (r *Nodes) FullId(fullid bool) *Nodes {
	r.values.Set("full_id", strconv.FormatBool(fullid))

...
func (r Aliases) Perform(ctx context.Context) (*http.Response, error) {
...
func (r Aliases) Do(ctx context.Context) (Response, error) {
...
func (r *Aliases) ExpandWildcards(v string) *Aliases {

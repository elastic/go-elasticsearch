...
// value. For example, you can apply a transient setting to override a
// persistent setting or `elasticsearch.yml` setting. However, a change to an
// `elasticsearch.yml` setting will not override a defined transient or
// persistent setting.
//
...
// configure dynamic cluster settings. Only use `elasticsearch.yml` for static

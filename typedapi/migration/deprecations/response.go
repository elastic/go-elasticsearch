...
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/migration/deprecations/DeprecationInfoResponse.ts#L23-L54
type Response struct {
	...
	// index-pattern in the query. This section includes warnings for the backing
	// indices of data streams specified in the request path.
	...
	// NodeSettings Node-level deprecation warnings. Since only a subset of your nodes might
	// incorporate these settings, it is important to read the details section for
	// more information about which nodes are affected.
	...
	// both component templates and index templates.

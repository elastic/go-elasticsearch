...
func New(tp elastictransport.Interface) *API {
	return &API{
		...
		Project: Project{
			CreateManyRouting: project_create_many_routing.NewCreateManyRoutingFunc(tp),
			CreateRouting:     project_create_routing.NewCreateRoutingFunc(tp),
			DeleteRouting:     project_delete_routing.NewDeleteRoutingFunc(tp),
			GetManyRouting:    project_get_many_routing.NewGetManyRoutingFunc(tp),
			GetRouting:        project_get_routing.NewGetRoutingFunc(tp),

...
// RrfRank type.
//
// https://github.com/elastic/elasticsearch-specification/blob/f6a370d0fba975752c644fc730f7c45610e28f36/specification/_types/Rank.ts#L32-L37
type RrfRank struct {
...
func (s *RrfRank) RrfRankCaster() *RrfRank {
	return s
}

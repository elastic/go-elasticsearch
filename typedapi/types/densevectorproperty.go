...
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/mapping/complex.ts#L51-L57
...
func (s *DenseVectorProperty) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "dims":
			if err := dec.Decode(&s.Dims); err != nil {
				return err
			}

...
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/mapping/specialized.ts#L78-L85
...
func (s *TokenCountProperty) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "enable_position_increments":
			if err := dec.Decode(&s.EnablePositionIncrements); err != nil {
				return err
			}

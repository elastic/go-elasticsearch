...
// IndexTemplateWithRollover type.
//
// https://github.com/elastic/elasticsearch-specification/blob/eb2e22fb2ac404e676d19bcc7bb089647f029026/specification/indices/_types/IndexTemplate.ts#L161-L163
type IndexTemplateWithRollover struct {
	AllowAutoCreate *bool `json:"allow_auto_create,omitempty"`
	// ComposedOf An ordered list of component template names. Component templates are merged
	// in the order specified, meaning that the last component template specified
	// has the highest precedence.
	ComposedOf []string `json:"composed_of"`
	// CreatedDate Date and time when the index template was created. Only returned if the
	// `human` query parameter is `true`.
	CreatedDate DateTime `json:"created_date,omitempty"`
	// CreatedDateMillis Date and time when the index template was created, in milliseconds since the
	// epoch.
	...
	// Meta_ Optional user metadata about the index template. May have any contents. This
	// map is not automatically generated by Elasticsearch.
	Meta_ Metadata `json:"_meta,omitempty"`
	// ModifiedDate Date and time when the index template was last modified. Only returned if the
	// `human` query parameter is `true`.
	ModifiedDate DateTime `json:"modified_date,omitempty"`
	// ModifiedDateMillis Date and time when the index template was last modified, in milliseconds
	// since the epoch.
	...
	// Template Template to be applied. It may optionally include an `aliases`, `mappings`,
	// or `settings` configuration.
	Template *IndexTemplateSummaryWithRollover `json:"template,omitempty"`
	// Version Version number used to manage index templates externally. This number is not
	// automatically generated by Elasticsearch.
	Version *int64 `json:"version,omitempty"`
}

func (s *IndexTemplateWithRollover) UnmarshalJSON(data []byte) error {
...
// NewIndexTemplateWithRollover returns a IndexTemplateWithRollover.
func NewIndexTemplateWithRollover() *IndexTemplateWithRollover {
	r := &IndexTemplateWithRollover{}

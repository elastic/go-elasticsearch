...
// SegmentsRecord type.
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/cat/segments/types.ts#L22-L107
type SegmentsRecord struct {
	...
	// DocsCount The number of documents in the segment. This excludes deleted documents and
	...
	// Generation The segment generation number. Elasticsearch increments this generation
	...
	// SizeMemory The segment memory in bytes. A value of `-1` indicates Elasticsearch was
	// unable to compute this number.

...
// TermsRangeQuery type.
//
// https://github.com/elastic/elasticsearch-specification/blob/9a0362eb2579c6604966a8fb307caee92de04270/specification/_types/query_dsl/term.ts#L166-L185
type TermsRangeQuery struct {
...
func (s *TermsRangeQuery) UnmarshalJSON(data []byte) error {
...
// NewTermsRangeQuery returns a TermsRangeQuery.
func NewTermsRangeQuery() *TermsRangeQuery {
	r := &TermsRangeQuery{}

...
// CoreKnnQuery type.
//
// https://github.com/elastic/elasticsearch-specification/blob/f6a370d0fba975752c644fc730f7c45610e28f36/specification/_global/knn_search/_types/Knn.ts#L24-L33
...
type CoreKnnQueryVariant interface {
	CoreKnnQueryCaster() *CoreKnnQuery
}

func (s *CoreKnnQuery) CoreKnnQueryCaster() *CoreKnnQuery {
	return s
}

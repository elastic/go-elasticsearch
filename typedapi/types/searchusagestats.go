...
//
// https://github.com/elastic/elasticsearch-specification/blob/aa1459fbdcaf57c653729142b3b6e9982373bb1c/specification/cluster/stats/types.ts#L149-L157
...
func (s *SearchUsageStats) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "extended":
			if err := dec.Decode(&s.Extended); err != nil {
				return fmt.Errorf("%s | %w", "Extended", err)
			}

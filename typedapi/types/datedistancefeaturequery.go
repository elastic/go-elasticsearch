...
//
// https://github.com/elastic/elasticsearch-specification/blob/135ae054e304239743b5777ad8d41cb2c9091d35/specification/_types/query_dsl/specialized.ts#L51-L54
...
func (rb *DateDistanceFeatureQueryBuilder) Pivot(pivot *TimeBuilder) *DateDistanceFeatureQueryBuilder {
	v := pivot.Build()
	rb.v.Pivot = v
	return rb
}

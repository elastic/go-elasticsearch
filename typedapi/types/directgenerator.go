...
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/_global/search/_types/suggester.ts#L270-L333
type DirectGenerator struct {
	...
	// terms — which are usually spelled correctly — from being spellchecked.
	// Can be a relative percentage number (for example `0.4`) or an absolute number
	// to represent document frequencies. If a value higher than 1 is specified,
	// then fractional can not be specified.

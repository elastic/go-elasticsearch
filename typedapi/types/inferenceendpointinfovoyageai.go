...
// InferenceEndpointInfoVoyageAI type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L232-L241
type InferenceEndpointInfoVoyageAI struct {
	...
	TaskType tasktypevoyageai.TaskTypeVoyageAI `json:"task_type"`
}

func (s *InferenceEndpointInfoVoyageAI) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoVoyageAI returns a InferenceEndpointInfoVoyageAI.
func NewInferenceEndpointInfoVoyageAI() *InferenceEndpointInfoVoyageAI {
	r := &InferenceEndpointInfoVoyageAI{}

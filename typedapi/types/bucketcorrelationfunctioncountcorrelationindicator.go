...
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/_types/aggregations/pipeline.ts#L160-L178
type BucketCorrelationFunctionCountCorrelationIndicator struct {
	...
	// required to be greater than or equal to the sum of all values in the
	// buckets_path as this is the originating superset of data to which the term
	// values are correlated.
	DocCount int `json:"doc_count"`
	// Expectations An array of numbers with which to correlate the configured `bucket_path`
	// values. The length of this value must always equal the number of buckets
	// returned by the `bucket_path`.

...
// Job type.
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/ml/_types/Job.ts#L61-L180
type Job struct {
	...
	// to the job by using the post data API. Note that when configuring a datafeed,
	...
	// is `null`. This property is informational; you cannot change its value.

...
// Body type.
//
// https://github.com/elastic/elasticsearch-specification/blob/49022a2c08d291955de83e26c583b7dc628fb558/specification/esql/list_queries/ListQueriesResponse.ts#L24-L30
type Body struct {
	Id               int64  `json:"id"`

...
// Body type.
//
// https://github.com/elastic/elasticsearch-specification/blob/8076b1c4ff3b8bd4eb5372bc75372577a21d1b0c/specification/esql/list_queries/ListQueriesResponse.ts#L24-L30
type Body struct {
	Id               int64  `json:"id"`

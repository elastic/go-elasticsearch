...
// Body type.
//
// https://github.com/elastic/elasticsearch-specification/blob/b1811e10a0722431d79d1c234dd412ff47d8656f/specification/esql/list_queries/ListQueriesResponse.ts#L24-L30
type Body struct {
	Id               int64  `json:"id"`

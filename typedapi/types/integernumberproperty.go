...
//
// https://github.com/elastic/elasticsearch-specification/blob/5fea44e006349579bf3561a82e997002e5716117/specification/_types/mapping/core.ts#L149-L152
...
func (s IntegerNumberProperty) MarshalJSON() ([]byte, error) {
	type innerIntegerNumberProperty IntegerNumberProperty
	tmp := innerIntegerNumberProperty{
		Boost:               s.Boost,
		Coerce:              s.Coerce,
		CopyTo:              s.CopyTo,

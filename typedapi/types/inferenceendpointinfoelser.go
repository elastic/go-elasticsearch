...
// InferenceEndpointInfoELSER type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L166-L175
type InferenceEndpointInfoELSER struct {
...
func (s *InferenceEndpointInfoELSER) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoELSER returns a InferenceEndpointInfoELSER.
func NewInferenceEndpointInfoELSER() *InferenceEndpointInfoELSER {
	r := &InferenceEndpointInfoELSER{}

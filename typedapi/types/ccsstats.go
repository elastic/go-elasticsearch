...
// CCSStats type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/cluster/stats/types.ts#L591-L606
...
func NewCCSStats() *CCSStats {
	r := &CCSStats{
		Clusters: make(map[string]RemoteClusterInfo, 0),
	}

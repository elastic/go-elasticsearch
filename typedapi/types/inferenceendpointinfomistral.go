...
// InferenceEndpointInfoMistral type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L210-L219
type InferenceEndpointInfoMistral struct {
	...
	TaskType tasktypemistral.TaskTypeMistral `json:"task_type"`
}

func (s *InferenceEndpointInfoMistral) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoMistral returns a InferenceEndpointInfoMistral.
func NewInferenceEndpointInfoMistral() *InferenceEndpointInfoMistral {
	r := &InferenceEndpointInfoMistral{}

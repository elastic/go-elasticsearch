...
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/ilm/_types/Phase.ts#L115-L118
...
func (s *DownsampleAction) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "wait_timeout":
			if err := dec.Decode(&s.WaitTimeout); err != nil {
				return fmt.Errorf("%s | %w", "WaitTimeout", err)
			}

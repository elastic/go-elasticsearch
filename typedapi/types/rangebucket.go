...
// RangeBucket type.
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/aggregations/Aggregate.ts#L533-L540
...
func (s *RangeBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "from_as_string":
			if err := dec.Decode(&s.FromAsString); err != nil {
				return err
			}
		...
		case "to_as_string":
			if err := dec.Decode(&s.ToAsString); err != nil {
				return err
			}

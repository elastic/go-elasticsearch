...
// InferenceEndpointInfoAmazonBedrock type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L100-L109
type InferenceEndpointInfoAmazonBedrock struct {
...
func (s *InferenceEndpointInfoAmazonBedrock) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoAmazonBedrock returns a InferenceEndpointInfoAmazonBedrock.
func NewInferenceEndpointInfoAmazonBedrock() *InferenceEndpointInfoAmazonBedrock {
	r := &InferenceEndpointInfoAmazonBedrock{}

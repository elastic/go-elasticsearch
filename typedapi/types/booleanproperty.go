...
//
// https://github.com/elastic/elasticsearch-specification/blob/abf9c2c6bb21328339daa197aae15af2ecbc46f0/specification/_types/mapping/core.ts#L94-L109
...
func (s BooleanProperty) MarshalJSON() ([]byte, error) {
	type innerBooleanProperty BooleanProperty
	tmp := innerBooleanProperty{
		Boost:               s.Boost,
		CopyTo:              s.CopyTo,

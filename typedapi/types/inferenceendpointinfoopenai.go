...
// InferenceEndpointInfoOpenAI type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L221-L230
type InferenceEndpointInfoOpenAI struct {
	...
	TaskType tasktypeopenai.TaskTypeOpenAI `json:"task_type"`
}

func (s *InferenceEndpointInfoOpenAI) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoOpenAI returns a InferenceEndpointInfoOpenAI.
func NewInferenceEndpointInfoOpenAI() *InferenceEndpointInfoOpenAI {
	r := &InferenceEndpointInfoOpenAI{}

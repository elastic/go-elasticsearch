...
// Retention type.
//
// https://github.com/elastic/elasticsearch-specification/blob/135ae054e304239743b5777ad8d41cb2c9091d35/specification/slm/_types/SnapshotLifecycle.ts#L78-L91
...
func (rb *RetentionBuilder) ExpireAfter(expireafter *TimeBuilder) *RetentionBuilder {
	v := expireafter.Build()
	rb.v.ExpireAfter = v
	return rb
}

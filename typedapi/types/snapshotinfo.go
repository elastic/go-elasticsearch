...
// SnapshotInfo type.
//
// https://github.com/elastic/elasticsearch-specification/blob/135ae054e304239743b5777ad8d41cb2c9091d35/specification/snapshot/_types/SnapshotInfo.ts#L35-L59
...
func (rb *SnapshotInfoBuilder) Duration(duration *TimeBuilder) *SnapshotInfoBuilder {
	v := duration.Build()
	rb.v.Duration = &v
	return rb
}

func (rb *SnapshotInfoBuilder) DurationInMillis(durationinmillis *EpochMillisBuilder) *SnapshotInfoBuilder {
	v := durationinmillis.Build()
	rb.v.DurationInMillis = &v
	return rb
}

func (rb *SnapshotInfoBuilder) EndTime(endtime *TimeBuilder) *SnapshotInfoBuilder {
	v := endtime.Build()
	rb.v.EndTime = &v
	return rb
}

func (rb *SnapshotInfoBuilder) EndTimeInMillis(endtimeinmillis *EpochMillisBuilder) *SnapshotInfoBuilder {
...
func (rb *SnapshotInfoBuilder) StartTime(starttime *TimeBuilder) *SnapshotInfoBuilder {
	v := starttime.Build()
	rb.v.StartTime = &v
	return rb
}

func (rb *SnapshotInfoBuilder) StartTimeInMillis(starttimeinmillis *EpochMillisBuilder) *SnapshotInfoBuilder {

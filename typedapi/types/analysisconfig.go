...
// AnalysisConfig type.
//
// https://github.com/elastic/elasticsearch-specification/blob/135ae054e304239743b5777ad8d41cb2c9091d35/specification/ml/_types/Analysis.ts#L29-L77
...
func (rb *AnalysisConfigBuilder) Latency(latency *TimeBuilder) *AnalysisConfigBuilder {
	v := latency.Build()
	rb.v.Latency = &v
	return rb
}
...
func (rb *AnalysisConfigBuilder) ModelPruneWindow(modelprunewindow *TimeBuilder) *AnalysisConfigBuilder {

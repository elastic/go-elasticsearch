...
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/simulate/ingest/SimulateIngestResponse.ts#L35-L78
...
func NewIngestDocumentSimulation() *IngestDocumentSimulation {
	r := &IngestDocumentSimulation{
		IngestDocumentSimulation: make(map[string]string, 0),

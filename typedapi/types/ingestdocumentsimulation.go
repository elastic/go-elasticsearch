...
//
// https://github.com/elastic/elasticsearch-specification/blob/e196f9953fa743572ee46884835f1934bce9a16b/specification/simulate/ingest/SimulateIngestResponse.ts#L36-L80
...
func (s *IngestDocumentSimulation) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "effective_mapping":
			if err := dec.Decode(&s.EffectiveMapping); err != nil {
				return fmt.Errorf("%s | %w", "EffectiveMapping", err)
			}

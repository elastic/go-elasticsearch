...
//
// https://github.com/elastic/elasticsearch-specification/blob/ac9c431ec04149d9048f2b8f9731e3c2f7f38754/specification/_types/mapping/core.ts#L164-L167
...
func (s ByteNumberProperty) MarshalJSON() ([]byte, error) {
	type innerByteNumberProperty ByteNumberProperty
	tmp := innerByteNumberProperty{
		Boost:               s.Boost,
		Coerce:              s.Coerce,
		CopyTo:              s.CopyTo,

...
//
// https://github.com/elastic/elasticsearch-specification/blob/6ee016a765be615b0205fc209d3d3c515044689d/specification/_types/aggregations/bucket.ts#L1153-L1219
type CategorizeTextAggregation struct {
	...
	// the analyzer in the `_analyze` endpoint. This property cannot be used at the
	// same time as categorization_filters.

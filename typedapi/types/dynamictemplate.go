...
//
// https://github.com/elastic/elasticsearch-specification/blob/6785a6caa1fa3ca5ab3308963d79dce923a3469f/specification/_types/mapping/dynamic-template.ts#L23-L43
	...
	for {
		...
		case "mapping":
			...
			case "exponential_histogram":
				o := NewExponentialHistogramProperty()
				if err := localDec.Decode(&o); err != nil {
					return fmt.Errorf("%s | %w", "exponential_histogram", err)
				}
				s.Mapping = *o
			case "ip":
				o := NewIpProperty()

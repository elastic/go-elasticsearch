...
// https://github.com/elastic/elasticsearch-specification/blob/ac9c431ec04149d9048f2b8f9731e3c2f7f38754/specification/_types/common.ts#L378-L384
...
func (c *ClusterInfoTarget) UnmarshalText(text []byte) error {
	...
	case "script":
		*c = Script
	default:
		*c = ClusterInfoTarget{string(text)}
	}

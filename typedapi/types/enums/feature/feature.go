...
// https://github.com/elastic/elasticsearch-specification/blob/0a58ae2e52dd1bc6227f65da9cbbcea5b61dde96/specification/indices/get/IndicesGetRequest.ts#L89-L93
type Feature struct {
	Name string
}

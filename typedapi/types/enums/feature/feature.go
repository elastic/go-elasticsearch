...
// https://github.com/elastic/elasticsearch-specification/blob/17fab0b2c19030e59a2eac3e1dab8fba7a8acb8f/specification/indices/get/IndicesGetRequest.ts#L100-L104
type Feature struct {
	Name string
}

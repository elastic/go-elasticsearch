...
// https://github.com/elastic/elasticsearch-specification/blob/eb2e22fb2ac404e676d19bcc7bb089647f029026/specification/inference/_types/CommonTypes.ts#L2084-L2088
...
func (f *FireworksAITaskType) UnmarshalText(text []byte) error {
	...
	case "text_embedding":
		*f = Textembedding
	default:
		*f = FireworksAITaskType{string(text)}
	}

	return nil
}

func (f FireworksAITaskType) String() string {
	return f.Name
}

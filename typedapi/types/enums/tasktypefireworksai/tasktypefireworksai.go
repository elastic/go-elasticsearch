...
// https://github.com/elastic/elasticsearch-specification/blob/836fca874204ca4173ae5c36fb6b5107d28d2fc0/specification/inference/_types/TaskType.ts#L172-L176
...
func (t *TaskTypeFireworksAI) UnmarshalText(text []byte) error {
	...
	case "text_embedding":
		*t = Textembedding
	default:
		*t = TaskTypeFireworksAI{string(text)}
	}

	return nil
}

func (t TaskTypeFireworksAI) String() string {
	return t.Name
}

...
// https://github.com/elastic/elasticsearch-specification/blob/eb2e22fb2ac404e676d19bcc7bb089647f029026/specification/inference/_types/CommonTypes.ts#L729-L733
...
func (a *AmazonSageMakerSimilarity) UnmarshalText(text []byte) error {
	...
	case "l2_norm":
		*a = L2norm
	default:
		*a = AmazonSageMakerSimilarity{string(text)}
	}

	return nil
}

func (a AmazonSageMakerSimilarity) String() string {
	return a.Name
}

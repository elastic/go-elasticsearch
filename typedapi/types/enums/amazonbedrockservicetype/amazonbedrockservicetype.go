...
// https://github.com/elastic/elasticsearch-specification/blob/eb2e22fb2ac404e676d19bcc7bb089647f029026/specification/inference/_types/AmazonBedrockTypes.ts#L99-L101
...
func (a *AmazonBedrockServiceType) UnmarshalText(text []byte) error {
	...
	case "amazonbedrock":
		*a = Amazonbedrock
	default:
		*a = AmazonBedrockServiceType{string(text)}
	}

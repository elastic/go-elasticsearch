...
// https://github.com/elastic/elasticsearch-specification/blob/470b4b9aaaa25cae633ec690e54b725c6fc939c7/specification/inference/_types/TaskType.ts#L60-L63
...
func (t TaskTypeAzureAIStudio) String() string {
	return t.Name
}

...
// https://github.com/elastic/elasticsearch-specification/blob/55f8d05b44cea956ae5ceddfcb02770ea2a24ff6/specification/inference/_types/CommonTypes.ts#L1942-L1946
...
func (o *OpenAISimilarityType) UnmarshalText(text []byte) error {
	...
	case "l2_norm":
		*o = L2norm
	default:
		*o = OpenAISimilarityType{string(text)}
	}

	return nil
}

func (o OpenAISimilarityType) String() string {
	return o.Name
}

...
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/inference/_types/CommonTypes.ts#L1927-L1931
...
func (l *LlamaSimilarityType) UnmarshalText(text []byte) error {
	...
	case "l2_norm":
		*l = L2norm
	default:
		*l = LlamaSimilarityType{string(text)}
	}

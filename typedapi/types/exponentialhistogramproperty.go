...
// ExponentialHistogramProperty type.
//
// https://github.com/elastic/elasticsearch-specification/blob/6785a6caa1fa3ca5ab3308963d79dce923a3469f/specification/_types/mapping/specialized.ts#L77-L80
...
func (s ExponentialHistogramProperty) MarshalJSON() ([]byte, error) {
	type innerExponentialHistogramProperty ExponentialHistogramProperty
	tmp := innerExponentialHistogramProperty{
		Dynamic:             s.Dynamic,
		Fields:              s.Fields,
	...
	tmp.Type = "exponential_histogram"

	return json.Marshal(tmp)
}

// NewExponentialHistogramProperty returns a ExponentialHistogramProperty.
func NewExponentialHistogramProperty() *ExponentialHistogramProperty {
	r := &ExponentialHistogramProperty{

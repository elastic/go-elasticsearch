...
// Retries type.
//
// https://github.com/elastic/elasticsearch-specification/blob/907d11a72a6bfd37b777d526880c56202889609e/specification/_types/Retries.ts#L22-L31
type Retries struct {
	...
	for {
		...
		case "bulk":
			...
			case string:
				...
				if err != nil {
					return fmt.Errorf("%s | %w", "Bulk", err)
				}
				s.Bulk = value
			case float64:
				f := int64(v)

...
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/ml/evaluate_data_frame/types.ts#L91-L93
	...
	for {
		...
		case "curve":
			if err := dec.Decode(&s.Curve); err != nil {
				return fmt.Errorf("%s | %w", "Curve", err)
			}

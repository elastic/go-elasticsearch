...
// ChangePointBucket type.
//
// https://github.com/elastic/elasticsearch-specification/blob/d82ef79f6af3e5ddb412e64fc4477ca1833d4a27/specification/_types/aggregations/Aggregate.ts#L394-L396
...
func (s *ChangePointBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "key":
			if err := dec.Decode(&s.Key); err != nil {
...
// NewChangePointBucket returns a ChangePointBucket.
func NewChangePointBucket() *ChangePointBucket {
	r := &ChangePointBucket{

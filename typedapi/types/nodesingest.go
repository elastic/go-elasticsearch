...
// NodesIngest type.
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/nodes/_types/Stats.ts#L345-L354
...
func NewNodesIngest() *NodesIngest {
	r := &NodesIngest{
		Pipelines: make(map[string]IngestStats, 0),
	}

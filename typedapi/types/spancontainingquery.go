...
//
// https://github.com/elastic/elasticsearch-specification/blob/bc885996c471cc7c2c7d51cba22aab19867672ac/specification/_types/query_dsl/span.ts#L25-L39
type SpanContainingQuery struct {
	// Big Can be any span query. Matching spans from `big` that contain matches from
	// `little` are returned.
	...
	// Little Can be any span query. Matching spans from `big` that contain matches from
	// `little` are returned.

...
// DocValues holds the union for the following types:
//
//	bool
//	DocValuesConfig
//
...
// as `multi_value`.
//
// https://github.com/elastic/elasticsearch-specification/blob/56c1eabdd35f941d1fbb3ad7ad8a9676664223f6/specification/_types/mapping/core.ts#L80-L84
type DocValues any

type DocValuesVariant interface {
	DocValuesCaster() *DocValues
}

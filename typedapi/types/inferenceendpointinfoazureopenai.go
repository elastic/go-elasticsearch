...
// InferenceEndpointInfoAzureOpenAI type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L133-L142
type InferenceEndpointInfoAzureOpenAI struct {
...
func (s *InferenceEndpointInfoAzureOpenAI) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoAzureOpenAI returns a InferenceEndpointInfoAzureOpenAI.
func NewInferenceEndpointInfoAzureOpenAI() *InferenceEndpointInfoAzureOpenAI {
	r := &InferenceEndpointInfoAzureOpenAI{}

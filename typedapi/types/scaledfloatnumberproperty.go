...
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/mapping/core.ts#L171-L175
...
func (s *ScaledFloatNumberProperty) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "scaling_factor":
			if err := dec.Decode(&s.ScalingFactor); err != nil {
				return err
			}

...
//
// https://github.com/elastic/elasticsearch-specification/blob/55f8d05b44cea956ae5ceddfcb02770ea2a24ff6/specification/_types/analysis/analyzers.ts#L213-L218
...
func (s IndonesianAnalyzer) MarshalJSON() ([]byte, error) {
	type innerIndonesianAnalyzer IndonesianAnalyzer
	tmp := innerIndonesianAnalyzer{
...
func (s *IndonesianAnalyzer) AnalyzerCaster() *Analyzer {
	if s == nil {
		return nil
	}
	o := Analyzer(s)

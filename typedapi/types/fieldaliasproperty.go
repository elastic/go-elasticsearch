...
//
// https://github.com/elastic/elasticsearch-specification/blob/5fea44e006349579bf3561a82e997002e5716117/specification/_types/mapping/specialized.ts#L49-L52
...
func (s FieldAliasProperty) MarshalJSON() ([]byte, error) {
	type innerFieldAliasProperty FieldAliasProperty
	tmp := innerFieldAliasProperty{
		Dynamic:     s.Dynamic,
		Fields:      s.Fields,

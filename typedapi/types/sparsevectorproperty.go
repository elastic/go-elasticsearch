...
//
// https://github.com/elastic/elasticsearch-specification/blob/5fea44e006349579bf3561a82e997002e5716117/specification/_types/mapping/core.ts#L193-L195
...
func (s SparseVectorProperty) MarshalJSON() ([]byte, error) {
	type innerSparseVectorProperty SparseVectorProperty
	tmp := innerSparseVectorProperty{
		Dynamic:     s.Dynamic,
		Fields:      s.Fields,

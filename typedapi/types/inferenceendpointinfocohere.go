...
// InferenceEndpointInfoCohere type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L144-L153
type InferenceEndpointInfoCohere struct {
...
func (s *InferenceEndpointInfoCohere) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoCohere returns a InferenceEndpointInfoCohere.
func NewInferenceEndpointInfoCohere() *InferenceEndpointInfoCohere {
	r := &InferenceEndpointInfoCohere{}

...
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/_global/get_script_context/types.ts#L22-L25
	...
	for {
		...
		case "methods":
			if err := dec.Decode(&s.Methods); err != nil {
				return fmt.Errorf("%s | %w", "Methods", err)
			}

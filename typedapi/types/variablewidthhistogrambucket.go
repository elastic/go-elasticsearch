...
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/aggregations/Aggregate.ts#L365-L372
...
func (s *VariableWidthHistogramBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "key_as_string":
			if err := dec.Decode(&s.KeyAsString); err != nil {
				return err
			}
		...
		case "max_as_string":
			if err := dec.Decode(&s.MaxAsString); err != nil {
				return err
			}
		...
		case "min_as_string":
			if err := dec.Decode(&s.MinAsString); err != nil {
				return err
			}

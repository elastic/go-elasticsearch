...
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/_types/analysis/tokenizers.ts#L111-L114
...
func (s SimplePatternTokenizer) MarshalJSON() ([]byte, error) {
	type innerSimplePatternTokenizer SimplePatternTokenizer
	tmp := innerSimplePatternTokenizer{
		Pattern: s.Pattern,
		Type:    s.Type,
		Version: s.Version,
	}

	tmp.Type = "simple_pattern"

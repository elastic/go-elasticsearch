...
// ParentReindexTask type.
//
// https://github.com/elastic/elasticsearch-specification/blob/836fca874204ca4173ae5c36fb6b5107d28d2fc0/specification/_global/reindex_rethrottle/types.ts#L50-L52
...
func (s *ParentReindexTask) UnmarshalJSON(data []byte) error {
...
// NewParentReindexTask returns a ParentReindexTask.
func NewParentReindexTask() *ParentReindexTask {
	r := &ParentReindexTask{}

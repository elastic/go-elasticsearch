...
// InferenceEndpointInfoGoogleVertexAI type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L188-L197
type InferenceEndpointInfoGoogleVertexAI struct {
	...
	TaskType tasktypegooglevertexai.TaskTypeGoogleVertexAI `json:"task_type"`
}

func (s *InferenceEndpointInfoGoogleVertexAI) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoGoogleVertexAI returns a InferenceEndpointInfoGoogleVertexAI.
func NewInferenceEndpointInfoGoogleVertexAI() *InferenceEndpointInfoGoogleVertexAI {
	r := &InferenceEndpointInfoGoogleVertexAI{}

...
//
// https://github.com/elastic/elasticsearch-specification/blob/1b56d7e58f5c59f05d1641c6d6a8117c5e01d741/specification/security/get_service_accounts/types.ts#L28-L30
type RoleDescriptorWrapper struct {
	RoleDescriptor RoleDescriptor `json:"role_descriptor"`
}
...
func (rb *RoleDescriptorWrapperBuilder) RoleDescriptor(roledescriptor *RoleDescriptorBuilder) *RoleDescriptorWrapperBuilder {

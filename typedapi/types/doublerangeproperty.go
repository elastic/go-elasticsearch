...
//
// https://github.com/elastic/elasticsearch-specification/blob/5fea44e006349579bf3561a82e997002e5716117/specification/_types/mapping/range.ts#L34-L36
...
func (s DoubleRangeProperty) MarshalJSON() ([]byte, error) {
	type innerDoubleRangeProperty DoubleRangeProperty
	tmp := innerDoubleRangeProperty{
		Boost:       s.Boost,
		Coerce:      s.Coerce,
		CopyTo:      s.CopyTo,

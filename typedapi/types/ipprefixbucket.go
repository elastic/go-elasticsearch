...
// IpPrefixBucket type.
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/aggregations/Aggregate.ts#L631-L636
...
func (s *IpPrefixBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "is_ipv6":
			if err := dec.Decode(&s.IsIpv6); err != nil {
				return err
			}
		...
		case "netmask":
			if err := dec.Decode(&s.Netmask); err != nil {
				return err
			}

		case "prefix_length":
			if err := dec.Decode(&s.PrefixLength); err != nil {
				return err
			}

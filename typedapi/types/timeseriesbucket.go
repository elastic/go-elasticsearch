...
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/_types/aggregations/Aggregate.ts#L733-L735
...
func (s *TimeSeriesBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "key":
			if s.Key == nil {
				s.Key = make(map[string]FieldValue, 0)
			}
...
func (s TimeSeriesBucket) MarshalJSON() ([]byte, error) {
	type opt TimeSeriesBucket

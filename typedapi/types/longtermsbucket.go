...
//
// https://github.com/elastic/elasticsearch-specification/blob/4ab557491062aab5a916a1e274e28c266b0e0708/specification/_types/aggregations/Aggregate.ts#L405-L408
...
func (s *LongTermsBucket) UnmarshalJSON(data []byte) error {
	...
	for {
		...
		case "doc_count_error":
			if err := dec.Decode(&s.DocCountError); err != nil {
				return err
			}

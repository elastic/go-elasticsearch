...
// BasqueAnalyzer type.
//
// https://github.com/elastic/elasticsearch-specification/blob/2f823ff6fcaa7f3f0f9b990dc90512d8901e5d64/specification/_types/analysis/analyzers.ts#L75-L80
...
func (s BasqueAnalyzer) MarshalJSON() ([]byte, error) {
	type innerBasqueAnalyzer BasqueAnalyzer
	tmp := innerBasqueAnalyzer{

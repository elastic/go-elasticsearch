...
// Authentication type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/security/delegate_pki/SecurityDelegatePkiResponse.ts#L43-L55
...
func NewAuthentication() *Authentication {
	r := &Authentication{
		...
		Token:  make(map[string]string, 0),
	}

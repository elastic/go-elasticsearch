...
// InferenceEndpointInfoElasticsearch type.
//
// https://github.com/elastic/elasticsearch-specification/blob/3a94b6715915b1e9311724a2614c643368eece90/specification/inference/_types/Services.ts#L155-L164
type InferenceEndpointInfoElasticsearch struct {
...
func (s *InferenceEndpointInfoElasticsearch) UnmarshalJSON(data []byte) error {
...
// NewInferenceEndpointInfoElasticsearch returns a InferenceEndpointInfoElasticsearch.
func NewInferenceEndpointInfoElasticsearch() *InferenceEndpointInfoElasticsearch {
	r := &InferenceEndpointInfoElasticsearch{}

...
func (r PutSynonym) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the PutSynonym query execution: %w", err)
	}
...
func (r PutSynonym) Do(ctx context.Context) (*Response, error) {
...
// API Name: id
func (r *PutSynonym) Id(id string) *PutSynonym {
	r.paramSet |= idMask
	r.id = id

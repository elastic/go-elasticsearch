...
func (r DeleteSynonym) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the DeleteSynonym query execution: %w", err)
	}
...
func (r DeleteSynonym) Do(ctx context.Context) (*Response, error) {
...
func (r DeleteSynonym) IsSuccess(ctx context.Context) (bool, error) {
	res, err := r.Perform(ctx)

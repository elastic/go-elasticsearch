...
func (r DeleteSynonymRule) Perform(ctx context.Context) (*http.Response, error) {
	...
	if err != nil {
		return nil, fmt.Errorf("an error happened during the DeleteSynonymRule query execution: %w", err)
	}
...
func (r DeleteSynonymRule) Do(ctx context.Context) (*Response, error) {

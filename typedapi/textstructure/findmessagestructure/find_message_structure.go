...
// determine why the returned structure was chosen.
//
// https://www.elastic.co/docs/api/doc/elasticsearch/v9/operation-text-structure-find-message-structure
...
// idea of meaning then generic field names such as `path`, `ipaddress`,
// `field1`, and `field2` are used in the `grok_pattern` output, with the
// intention that a user who knows the meanings rename these fields before using
// it.
...
// delimited format to be detected. If the format is `delimited` and the

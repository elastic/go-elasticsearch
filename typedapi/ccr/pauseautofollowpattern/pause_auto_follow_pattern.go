...
func (r PauseAutoFollowPattern) Perform(ctx context.Context) (*http.Response, error) {
...
func (r PauseAutoFollowPattern) Do(ctx context.Context) (*Response, error) {
...
// to follow.
// API Name: name
func (r *PauseAutoFollowPattern) Name(name string) *PauseAutoFollowPattern {
	r.paramSet |= nameMask
	r.name = name

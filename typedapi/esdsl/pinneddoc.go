...
func (s *_pinnedDoc) PinnedQueryCaster() *types.PinnedQuery {
	container := types.NewPinnedQuery()

	container.Docs = append(container.Docs, *s.v)

	return container
}

func (s *_pinnedDoc) PinnedDocCaster() *types.PinnedDoc {
	return s.v
}

...
func NewDataStreamFailureStore() *_dataStreamFailureStore {

	return &_dataStreamFailureStore{v: types.NewDataStreamFailureStore()}
...
func (s *_dataStreamFailureStore) Lifecycle(lifecycle types.FailureStoreLifecycleVariant) *_dataStreamFailureStore {
	...
	s.v.Lifecycle = lifecycle.FailureStoreLifecycleCaster()

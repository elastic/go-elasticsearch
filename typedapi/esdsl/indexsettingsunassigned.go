...
func NewIndexSettingsUnassigned() *_indexSettingsUnassigned {

	return &_indexSettingsUnassigned{v: types.NewIndexSettingsUnassigned()}

}

func (s *_indexSettingsUnassigned) NodeLeft(nodeleft types.IndexSettingsUnassignedNodeLeftVariant) *_indexSettingsUnassigned {

	s.v.NodeLeft = nodeleft.IndexSettingsUnassignedNodeLeftCaster()

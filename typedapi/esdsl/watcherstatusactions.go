...
func NewWatcherStatusActions(watcherstatusactions map[string]types.ActionStatusVariant) *_watcherStatusActions {
	return &_watcherStatusActions{v: make(map[string]types.ActionStatus, 0)}
}

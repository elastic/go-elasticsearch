...
func (s *_dataframeAnalysisClassification) FeatureProcessorsValues(featureprocessorsvalues []types.DataframeAnalysisFeatureProcessor) *_dataframeAnalysisClassification {

...
func NewCommonGramsTokenFilter() *_commonGramsTokenFilter {
	...
	return &_commonGramsTokenFilter{v: types.NewCommonGramsTokenFilter()}

}

func (s *_commonGramsTokenFilter) CommonWords(commonwords ...string) *_commonGramsTokenFilter {

	for _, v := range commonwords {

		s.v.CommonWords = append(s.v.CommonWords, v)
...
func (s *_commonGramsTokenFilter) CommonWordsPath(commonwordspath string) *_commonGramsTokenFilter {
	...
	s.v.CommonWordsPath = &commonwordspath

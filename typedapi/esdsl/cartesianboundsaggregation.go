...
// A metric aggregation that computes the spatial bounding box containing all
// values for a Point or Shape field.
func NewCartesianBoundsAggregation() *_cartesianBoundsAggregation {

	return &_cartesianBoundsAggregation{v: types.NewCartesianBoundsAggregation()}

...
func NewMergeScheduler() *_mergeScheduler {
	...
	return &_mergeScheduler{v: types.NewMergeScheduler()}

}

func (s *_mergeScheduler) MaxMergeCount(stringifiedinteger types.StringifiedintegerVariant) *_mergeScheduler {

	s.v.MaxMergeCount = *stringifiedinteger.StringifiedintegerCaster()
...
func (s *_mergeScheduler) MaxThreadCount(stringifiedinteger types.StringifiedintegerVariant) *_mergeScheduler {
	...
	s.v.MaxThreadCount = *stringifiedinteger.StringifiedintegerCaster()

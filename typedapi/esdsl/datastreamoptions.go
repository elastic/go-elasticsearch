...
func NewDataStreamOptions() *_dataStreamOptions {

	return &_dataStreamOptions{v: types.NewDataStreamOptions()}

}

func (s *_dataStreamOptions) FailureStore(failurestore types.DataStreamFailureStoreVariant) *_dataStreamOptions {

	s.v.FailureStore = failurestore.DataStreamFailureStoreCaster()

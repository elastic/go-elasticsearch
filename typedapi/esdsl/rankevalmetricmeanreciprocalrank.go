...
func NewRankEvalMetricMeanReciprocalRank() *_rankEvalMetricMeanReciprocalRank {
	...
	return &_rankEvalMetricMeanReciprocalRank{v: types.NewRankEvalMetricMeanReciprocalRank()}
...
func (s *_rankEvalMetricMeanReciprocalRank) RankEvalMetricMeanReciprocalRankCaster() *types.RankEvalMetricMeanReciprocalRank {
	return s.v
}

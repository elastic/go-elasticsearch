...
func NewExtendedBoundsFieldDateMath() *_extendedBoundsFieldDateMath {
	...
	return &_extendedBoundsFieldDateMath{v: types.NewExtendedBoundsFieldDateMath()}
...
func (s *_extendedBoundsFieldDateMath) ExtendedBoundsFieldDateMathCaster() *types.ExtendedBoundsFieldDateMath {
	return s.v
}

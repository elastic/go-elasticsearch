...
func NewTrainedModelPrefixStrings() *_trainedModelPrefixStrings {
	...
	return &_trainedModelPrefixStrings{v: types.NewTrainedModelPrefixStrings()}
...
func (s *_trainedModelPrefixStrings) TrainedModelPrefixStringsCaster() *types.TrainedModelPrefixStrings {
	return s.v
}

...
func NewTermsInclude() *_termsInclude {
	return &_termsInclude{v: nil}
}

func (u *_termsInclude) String(string string) *_termsInclude {
...
func (u *_termsInclude) TermsPartition(termspartition types.TermsPartitionVariant) *_termsInclude {
	...
	u.v = termspartition.TermsPartitionCaster()

	return u
}

// Interface implementation for TermsPartition in TermsInclude union
func (u *_termsPartition) TermsIncludeCaster() *types.TermsInclude {
	t := types.TermsInclude(u.v)
	return &t
}

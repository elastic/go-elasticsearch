...
//
// options: optional parameters. Supports the following functional options: WithErrorTrace, WithFilterPath, WithHuman, WithParent, WithPreference, WithPretty, WithRealtime, WithRefresh, WithRouting, WithSource, WithSourceExclude, WithSourceInclude, WithSourceParam, WithVersion, WithVersionType, see the Option type in this package for more info.
func (a *API) ExistsSource(documentType string, id string, index string, options ...*Option) (*http.Response, error) {

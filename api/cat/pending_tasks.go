...
// PendingTasks - see http://www.elastic.co/guide/en/elasticsearch/reference/master/cat-pending-tasks.html for more info.
//
...
func (c *Cat) PendingTasks(options ...*Option) (*http.Response, error) {

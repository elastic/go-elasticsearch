...
// under the License.
//
// Code generated from specification version 8.8.1: DO NOT EDIT
...
func (r SearchApplicationPostBehavioralAnalyticsEventRequest) Do(ctx context.Context, transport Transport) (*Response, error) {
	var (
		method string

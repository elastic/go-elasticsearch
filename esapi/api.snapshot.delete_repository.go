...
// NewSnapshotDeleteRepository creates a new API client for the SnapshotDeleteRepository endpoint
//
func NewSnapshotDeleteRepository(t Transport) SnapshotDeleteRepository {

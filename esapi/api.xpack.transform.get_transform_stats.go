...
// NewTransformGetTransformStats creates a new API client for the TransformGetTransformStats endpoint
//
func NewTransformGetTransformStats(t Transport) TransformGetTransformStats {

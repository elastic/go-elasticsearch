...
// NewLicenseGetTrialStatus creates a new API client for the LicenseGetTrialStatus endpoint
//
func NewLicenseGetTrialStatus(t Transport) LicenseGetTrialStatus {

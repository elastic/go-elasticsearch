...
// NewSearchableSnapshotsStats creates a new API client for the SearchableSnapshotsStats endpoint
//
func NewSearchableSnapshotsStats(t Transport) SearchableSnapshotsStats {

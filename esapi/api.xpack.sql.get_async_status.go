...
// SQLGetAsyncStatus - Get the async SQL search status
//
// See full documentation at https://www.elastic.co/guide/en/elasticsearch/reference/8.19/get-async-sql-search-status-api.html.

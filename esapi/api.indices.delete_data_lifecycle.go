...
// IndicesDeleteDataLifecycle deletes the data lifecycle of the selected data streams.
//
// This API is experimental.
//
// See full documentation at https://www.elastic.co/guide/en/elasticsearch/reference/master/dlm-delete-lifecycle.html.

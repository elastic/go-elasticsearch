...
func newEsqlDeleteViewFunc(t Transport) EsqlDeleteView {
	return func(name string, o ...func(*EsqlDeleteViewRequest)) (*Response, error) {
		var r = EsqlDeleteViewRequest{Name: name}
		for _, f := range o {
			f(&r)
		}
...
// EsqlDeleteView - Delete a non-materialized VIEW for ESQL.
//
// This API is experimental.
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-esql-view-delete.
type EsqlDeleteView func(name string, o ...func(*EsqlDeleteViewRequest)) (*Response, error)

// EsqlDeleteViewRequest configures the Esql Delete View API request.
...
func (f EsqlDeleteView) WithContext(v context.Context) func(*EsqlDeleteViewRequest) {
	return func(r *EsqlDeleteViewRequest) {
		r.ctx = v
	}
}

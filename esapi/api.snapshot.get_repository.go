...
// NewSnapshotGetRepository creates a new API client for the SnapshotGetRepository endpoint
//
func NewSnapshotGetRepository(t Transport) SnapshotGetRepository {

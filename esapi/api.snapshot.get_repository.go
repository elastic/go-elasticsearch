...
// SnapshotGetRepository get snapshot repository information
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-snapshot-get-repository.

...
func newIngestDeleteGeoipDatabaseFunc(t Transport) IngestDeleteGeoipDatabase {
	return func(id []string, o ...func(*IngestDeleteGeoipDatabaseRequest)) (*Response, error) {
		var r = IngestDeleteGeoipDatabaseRequest{DocumentID: id}
		for _, f := range o {
			f(&r)
		}
...
// IngestDeleteGeoipDatabase delete GeoIP database configurations
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-ingest-delete-geoip-database.

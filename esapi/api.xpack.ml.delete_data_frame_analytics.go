...
// MLDeleteDataFrameAnalytics - Delete a data frame analytics job
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-delete-data-frame-analytics.

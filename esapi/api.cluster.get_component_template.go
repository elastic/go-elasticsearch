...
// NewClusterGetComponentTemplate creates a new API client for the ClusterGetComponentTemplate endpoint
//
func NewClusterGetComponentTemplate(t Transport) ClusterGetComponentTemplate {

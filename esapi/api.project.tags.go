...
func newProjectTagsFunc(t Transport) ProjectTags {
	return func(o ...func(*ProjectTagsRequest)) (*Response, error) {
		var r = ProjectTagsRequest{}
		for _, f := range o {
			f(&r)
		}
...
func (r ProjectTagsRequest) Do(providedCtx context.Context, transport Transport) (*Response, error) {
	...
	path.WriteString("/_project/tags")
...
func (f ProjectTags) WithPretty() func(*ProjectTagsRequest) {
	return func(r *ProjectTagsRequest) {
		r.Pretty = true
	}
}
...
func (f ProjectTags) WithHuman() func(*ProjectTagsRequest) {
	return func(r *ProjectTagsRequest) {
		r.Human = true
	}
}

...
// NewIndicesExistsIndexTemplate creates a new API client for the IndicesExistsIndexTemplate endpoint
//
func NewIndicesExistsIndexTemplate(t Transport) IndicesExistsIndexTemplate {

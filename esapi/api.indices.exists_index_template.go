...
// IndicesExistsIndexTemplate check index templates
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/v8/operation/operation-indices-exists-index-template.

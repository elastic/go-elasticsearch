...
// NewSecurityGetPrivileges creates a new API client for the SecurityGetPrivileges endpoint
//
func NewSecurityGetPrivileges(t Transport) SecurityGetPrivileges {

...
// NewSecurityGetUserPrivileges creates a new API client for the SecurityGetUserPrivileges endpoint
//
func NewSecurityGetUserPrivileges(t Transport) SecurityGetUserPrivileges {

...
// MLPutTrainedModelAlias - Create or update a trained model alias
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-ml-put-trained-model-alias.

...
// NewIndicesDeleteIndexTemplate creates a new API client for the IndicesDeleteIndexTemplate endpoint
//
func NewIndicesDeleteIndexTemplate(t Transport) IndicesDeleteIndexTemplate {

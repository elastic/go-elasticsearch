...
// SecurityPutRoleMapping - Create or update role mappings
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-security-put-role-mapping.

...
// ConnectorUpdateServiceDocumentType update the connector service type
//
// This API is beta.
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-connector-update-service-type.

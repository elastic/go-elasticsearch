...
// NewSnapshotCreateRepository creates a new API client for the SnapshotCreateRepository endpoint
//
func NewSnapshotCreateRepository(t Transport) SnapshotCreateRepository {

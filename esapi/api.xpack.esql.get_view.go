...
func newEsqlGetViewFunc(t Transport) EsqlGetView {
	return func(o ...func(*EsqlGetViewRequest)) (*Response, error) {
		var r = EsqlGetViewRequest{}
		for _, f := range o {
			f(&r)
		}
...
// EsqlGetView - Get a non-materialized VIEW for ESQL.
//
// This API is experimental.
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-esql-view-get.
type EsqlGetView func(o ...func(*EsqlGetViewRequest)) (*Response, error)

// EsqlGetViewRequest configures the Esql Get View API request.
...
func (r EsqlGetViewRequest) Do(providedCtx context.Context, transport Transport) (*Response, error) {
	...
	path.Grow(7 + 1 + len("_query") + 1 + len("view") + 1 + len(strings.Join(r.Name, ",")))
...
func (f EsqlGetView) WithContext(v context.Context) func(*EsqlGetViewRequest) {
	return func(r *EsqlGetViewRequest) {
		r.ctx = v
	}
}

// WithName - a list of view names.
...
func (f EsqlGetView) WithPretty() func(*EsqlGetViewRequest) {
	return func(r *EsqlGetViewRequest) {
		r.Pretty = true
	}
}
...
func (f EsqlGetView) WithHuman() func(*EsqlGetViewRequest) {
	return func(r *EsqlGetViewRequest) {
		r.Human = true
	}
}

...
// QueryRulesDeleteRuleset delete a query ruleset
//
// See full documentation at https://www.elastic.co/docs/api/doc/elasticsearch/operation/operation-query-rules-delete-ruleset.

...
//
// options: optional parameters. Supports the following functional options: WithMasterTimeout, WithTimeout, WithUpdateAllTypes, WithWaitForActiveShards, see the Option type in this package for more info.

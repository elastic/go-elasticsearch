...
// Interface defines an interface for logging request and response.
//
...
func (l *Text) LogRoundTrip(req *http.Request, res *http.Response, err error, start time.Time, dur time.Duration) error {
...
func (l *Text) RequestBodyEnabled() bool  { return l.EnableRequestBody }
func (l *Text) ResponseBodyEnabled() bool { return l.EnableResponseBody }

// --- Color

func (l *Color) LogRoundTrip(req *http.Request, res *http.Response, err error, start time.Time, dur time.Duration) error {
...
func (l *Color) RequestBodyEnabled() bool  { return l.EnableRequestBody }
func (l *Color) ResponseBodyEnabled() bool { return l.EnableResponseBody }

// --- Curl

func (l *Curl) LogRoundTrip(req *http.Request, res *http.Response, err error, start time.Time, dur time.Duration) error {
	var b bytes.Buffer
...
func (l *Curl) RequestBodyEnabled() bool  { return l.EnableRequestBody }
func (l *Curl) ResponseBodyEnabled() bool { return l.EnableResponseBody }

// --- JSON

func (l *JSON) LogRoundTrip(req *http.Request, res *http.Response, err error, start time.Time, dur time.Duration) error {
...
func (l *JSON) RequestBodyEnabled() bool  { return l.EnableRequestBody }
func (l *JSON) ResponseBodyEnabled() bool { return l.EnableResponseBody }
